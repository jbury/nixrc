...
let
	...
	profileName = homeSettings.userName;
in {
	config = mkIf homeSettings.hasDesktop {
		stylix.targets.firefox.profileNames = [ "jbury" ];
		...
		programs.firefox = {
			...
			profiles."${profileName}".settings = {
				...
				# Backspace key lets you go back
				"browser.backspace_action" = 0;

				# ctrl-q is real close to ctrl-tab
				"browser.quitshortcut.disabled" = true;

				# Gimme the last session on startup
				"browser.startup.page" = 3;

				# Gimme my clickable bookmark bar
				"browser.toolbars.bookmarks.visibility" = "always";

				## Basic settings err'body wants
				...
				"browser.download.dir" = "${homeSettings.homeDirectory}/Downloads";
		...
		in {
			...
			"${cfgPath}/${profileName}.default/chrome/userChrome.css".text = concatMapStringsSep "\n" readFile [
