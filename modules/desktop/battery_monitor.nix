...
# Lovingly stolen from https://github.com/Julow/env/blob/216873054b9358a5f4c70309213544667d172ec2/modules/battery_monitor.nix
...
let
  ...
  cfg = config.modules.desktop.battery_monitor;
in {
  options.modules.desktop.battery_monitor = {
