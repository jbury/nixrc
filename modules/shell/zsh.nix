...
let
  inherit (lib) mkIf mapAttrsToList concatStringsSep concatMapStrings;
  inherit (lib.types) either str path lines listOf attrsOf;
  inherit (lib.my) mkOpt mkOpt' mkBoolOpt;

  currentFile = "modules/shell/zsh.nix";
